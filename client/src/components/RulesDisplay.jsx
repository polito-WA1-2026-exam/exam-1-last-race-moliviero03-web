    ...
    return (
        <Container>
            ...
            <ol>
                ...
                he can click on th "GO ON" button to go to the next phase.</li>
                ...
                In the map, two staions are highlighted: the starting and the finish stations.
                The player has 90 seconds to create a route, that is a sequence of connections,
                to connect the start and finish station. Once done, he has to click the "SUBMIT" button
                ...
                if not, he can click the "Home" button to go bakc to the home.</li>
            </ol>
        </Container>
    )
}
